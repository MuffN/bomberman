...
// necessary to find a way out of blast 
		if (isAlive()) {
			if (timerStuck <= 0) {
				stuck();
...
//		graphics.setColor(Color.black);
	...
	// determine if the bot is currently stuck to its location also to find a way out of threat
	private void stuck() {
