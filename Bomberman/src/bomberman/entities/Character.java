...
public abstract class Character extends Entity {
	...
	private void init() {
		...
		case 1:
			...
			deathImg = Asset.dead_character1;
			setX(60);
			setY(60);
			break;
		case 2:
			setImage(Asset.character2);
			deathImg = Asset.dead_character2;
			setX(780);
			setY(60);
			break;
		case 3:
			setImage(Asset.character3);
			deathImg = Asset.dead_character3;
			setX(780);
			setY(660);
			break;
		case 4:
			setImage(Asset.character4);
			deathImg = Asset.dead_character4;
			setX(60);
			setY(660);
			break;
		default:
//			/System.out.println("ERROR INCORRECT PLAYER NUMBER!");
	...
	private boolean checkBlast() {
		...
		if(!(this.getClass().getSimpleName().equals("Bot"))|| !Settings.INVINCIBLE_BOTS) {
	...
	public void setAllowedBombs(int allowedBombs) {
		...
		if(this.allowedBombs<minBombs) {
			this.allowedBombs=minBombs;
		}
	}
